(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'JpQgSAZ9aLybiAWUsdiMJMRDZszZGeNt5gGrI2Su8Zp8rHJt', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1085848370], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Fermentation Temperature', // Replaces Xively logo in the header
		dataDuration	= '6hours', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 15, // Default interval for data to be displayed (in seconds)
		dataColor		= '234567', // CSS HEX value of color to represent data (omit leading #)
